                    ...
                    <div className="owl-two owl-carousel owl-theme">
                        ...
                        <div className="item">
                            <div className="slider-info mt-lg-4 mt-3">
                                <div className="message">
                                    <img src="assets/images/quote.png" alt="" className="img-fluid mb-2" />
                                    <p><q>Software Engineer at Ketanech Technology Services.</q></p>
                                    <div className="name mt-4 mb-4">
                                        <h4>Oketoye Odunayo</h4>
                        ...
                        <div className="item">
                            <div className="slider-info mt-lg-4 mt-3">
                                <div className="message">
                                    <img src="assets/images/quote.png" alt="" className="img-fluid mb-2" />
                                    <p><q>Hardware Engineer at Ketanech Technology Services</q></p>
                                    <div className="name mt-4 mb-4">
                                        <h4>Mariam</h4>
                                ...
                                <div className="img-circle">
                                    <img src="assets/images/odun.png" className="img-fluid radius-image" alt="Hardware Engineer" />
                                </div>
                            </div>
                        </div>
                    </div>
